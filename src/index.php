  ...
  <main role="main" class="container">
    <div class="row">
      <div class="btn-group mt-2 btn-block" role="group" aria-label="Basic example">
        ...
        <a href="index.php<?= $sorteer == "prijs"? "": "?sorteer=prijs" ?>" class="btn <?= $_GET["sorteer"] == "prijs" ? "btn-primary" : "btn-secondary" ?>">Prijs</a>
        <a href="index.php<?= $sorteer == "naam"? "": "?sorteer=naam" ?>" class="btn <?= $_GET["sorteer"] == "naam" ? "btn-primary" : "btn-secondary" ?>">Naam</a>
      </div>
      <?php 
