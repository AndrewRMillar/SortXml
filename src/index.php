...
<head>
  ...
  <link 
    rel="shortcut icon" 
    href="https://www.noverius.nl/sites/all/themes/noverius/favicon.ico" 
...
<body>
  <div class="navbar navbar-custom navbar-static-top affix-top noverius-header">
    <div class="col-xs-6 col-sm-3 col-md-3">
      <a 
        id="logo" 
        href="https://www.noverius.nl/nl" 
        title="Website &amp; Applicatie Ontwikkeling"></a>        
    </div>  
  </div>
  <main role="main" class="container">
    <div class="row">
      <div class="btn-group mt-2 btn-block" role="group" aria-label="Basic example">
        ...
        <a 
          href="index.php<?= $sorteer === "prijs"? "": "?sorteer=prijs" ?>" 
          class="btn <?= $sorteer === "prijs" ? "btn-primary" : "btn-secondary" ?>">Prijs</a>
        <a 
         href="index.php<?= $sorteer === "naam"? "": "?sorteer=naam" ?>" 
         class="btn <?= $sorteer === "naam" ? "btn-primary" : "btn-secondary" ?>">Naam</a>
      </div>
        <?php 
